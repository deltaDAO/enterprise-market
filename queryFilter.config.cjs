...
//   credentialSubject: { metadata: { tags: { keyword: 'accurate' } } }       → term filter (.keyword sub-field)
//   credentialSubject: { metadata: { tags: { match: 'accurate' } } }         → match filter (full-text, use with caution)
//
module.exports = {
  credentialSubject: {
    metadata: {
