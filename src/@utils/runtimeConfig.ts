export type RuntimeConfig = {
  ...
  NEXT_PUBLIC_PRIVACY_PREFERENCE_CENTER?: string
  ...
  NEXT_PUBLIC_CENTRAL_IDP_NAME?: string
  ...
  NEXT_PUBLIC_DFNS_ENABLED?: string
  NEXT_PUBLIC_DFNS_API_URL?: string
  NEXT_PUBLIC_DFNS_RP_ID?: string
...
const runtimeConfig: RuntimeConfig = (() => {
  const baseConfig: RuntimeConfig = {
    ...
    NEXT_PUBLIC_CENTRAL_IDP_NAME: process.env.NEXT_PUBLIC_CENTRAL_IDP_NAME,
    ...
    NEXT_PUBLIC_DFNS_ENABLED: process.env.NEXT_PUBLIC_DFNS_ENABLED,
    NEXT_PUBLIC_DFNS_API_URL: process.env.NEXT_PUBLIC_DFNS_API_URL,
    NEXT_PUBLIC_DFNS_RP_ID: process.env.NEXT_PUBLIC_DFNS_RP_ID,
