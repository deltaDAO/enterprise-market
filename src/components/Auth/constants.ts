...
export const authSetupCopy = {
  ...
  connectBrowserWallet: 'Connect with Metamask',
  connectDfnsWallet: 'Connect with Smart Account',
  connectSignerServer: 'Connect to Signer Server',
  connectJsonWallet: 'Connect with Wallet File',
  dfnsConnecting: 'Connecting Dfns...',
  signerServerConnecting: 'Connecting Signer Server...',
